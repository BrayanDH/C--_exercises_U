...
// Funcion para mover el cursor a una poscicion especifica en la consola
void gotoxy(int x, int y)
{
  ...
  coord.X = x;
  coord.Y = y;
  // Obtener el handle de la consola y establecer la poscicion del cursor
...
int main(void)
{
  ...
  // Verificar si el archivo se abrir correctamente
  if (!archivo.is_open())
  {
